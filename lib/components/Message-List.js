...
get messageDecision(){
  ...
  render() {
    ...
    return (
      <div>
        <ul>
          { this.props.messages.map(m => <li key={m.key}> <article className="date-name"><span className="message-date">{m.createdAt}</span> <span className="message-date-mobile">{m.createdAtMobile}</span>
