    ...
    return (
      <div className="Application">
        <article className="sort-filter-field">
          ...
          <SortButtons messages={this.state.messages} sortMessagesFunction={this.sortMessages.bind(this)}/>
        </article>
        <article className="messages-users">
          <div className="messages">
            <MessageList messages={this.state.messages} filterMessages={this.state.filter}/>
          </div>
          <UserList messages={this.state.messages} currentUser={this.state.user}/>
        </article>
